...
// [3.0, 14.5, 11.0]`}
  testCases={[
    { input: 'JSON.stringify(averageOfLevels(new TreeNode(1, new TreeNode(6, new TreeNode(1), new TreeNode(5)), new TreeNode(8))))', expected: '[1,6,1]' },
    { input: 'JSON.stringify(averageOfLevels(new TreeNode(3, new TreeNode(9), new TreeNode(20, new TreeNode(15), new TreeNode(7)))))', expected: '[3,9]' }
  ]}
/>
