...
`}
  testCases={[
    { input: 'minDiffInBST(tree1)', expected: '1' },
    { input: 'minDiffInBST(tree2)', expected: '8' },
    { input: 'minDiffInBST(tree3)', expected: '98' }
  ]}
/>
...
print(min_diff_in_bst(tree2))  # 8
print(min_diff_in_bst(tree3))  # 98
`}
/>
