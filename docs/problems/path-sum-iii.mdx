...
console.log('Example 2:', pathSum(root2, 2)); // 3`}
  testCases={[
    { input: 'pathSum(new TreeNode(3, new TreeNode(1), new TreeNode(8)), 11)', expected: '1' },
    { input: 'pathSum(new TreeNode(2, new TreeNode(-4, new TreeNode(2)), new TreeNode(9)), 2)', expected: '3' }
  ]}
/>
...
print('Example 2:', path_sum(root2, 2))  # 3`}
  testCases={[
    { input: 'path_sum(TreeNode(3, TreeNode(1), TreeNode(8)), 11)', expected: '1' },
    { input: 'path_sum(TreeNode(2, TreeNode(-4, TreeNode(2)), TreeNode(9)), 2)', expected: '3' }
  ]}
/>
