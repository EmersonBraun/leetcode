...
console.log('Example 2:', rangeSumBST(root2, 7, 15)); // 32`}
  testCases={[
    { input: 'rangeSumBST(new TreeNode(1, new TreeNode(7, new TreeNode(4)), new TreeNode(5, new TreeNode(3), new TreeNode(9))), 3, 5)', expected: '4' },
    { input: 'rangeSumBST(new TreeNode(10, new TreeNode(5, new TreeNode(3), new TreeNode(7)), new TreeNode(15, null, new TreeNode(18))), 7, 15)', expected: '10' }
  ]}
/>
...
print('Example 2:', range_sum_bst(root2, 7, 15))  # 32`}
  testCases={[
    ...
    { input: 'range_sum_bst(TreeNode(10, TreeNode(5, TreeNode(3), TreeNode(7)), TreeNode(15, None, TreeNode(18))), 7, 15)', expected: '10' }
  ]}
/>
