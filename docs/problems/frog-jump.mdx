...
The frog can jump:
  - From stone 0 to stone 1 (jump size 1)
  - From stone 1 to stone 3 (jump size 2, last was 1, can do 0,1,2)
  - From stone 3 to stone 5 (jump size 2, last was 2, can do 1,2,3)
  - From stone 5 to stone 8 (jump size 3, last was 2, can do 1,2,3)
  - From stone 8 to stone 12 (jump size 4, last was 3, can do 2,3,4)
  - From stone 12 to stone 17 (jump size 5, last was 4, can do 3,4,5)
Successfully reaches the last stone.
```
...
Output: false
Explanation:
There is no way to jump to stone 8 from any reachable stone with the given constraints.
```
...
// true`}
  testCases={[
    ...
    { input: 'canCross([0, 1, 3, 5, 6, 8, 12, 17])', expected: 'true' }
  ]}
/>
...
# True`}
  testCases={[
    ...
    { input: 'can_cross([0, 1, 3, 5, 6, 8, 12, 17])', expected: 'True' }
  ]}
/>
