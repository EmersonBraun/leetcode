...
// [4, 1, 8, 2, 7]`}
  testCases={[
    { input: 'JSON.stringify(inorderTraversal(new TreeNode(2, new TreeNode(1), new TreeNode(3))))', expected: '[1,2,3]' },
    { input: 'JSON.stringify(inorderTraversal(new TreeNode(2, new TreeNode(1, new TreeNode(4), new TreeNode(8)), new TreeNode(7))))', expected: '[4,1,8,2,7]' }
  ]}
/>
